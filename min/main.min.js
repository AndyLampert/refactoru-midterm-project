...
var User=function(e,r,s,i){this.location=e,this.likes=r,this.agePref=s,this.readyFor=i},userLocation=new User(""),userLikes=new User(""),userAgePref=new User(""),userReadyFor=new User("");
